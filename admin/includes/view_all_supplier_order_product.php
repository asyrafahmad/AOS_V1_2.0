...
<!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Senarai Pesanan Produk</h1>
...
//                            echo "<td><a href='users.php?change_to_subscriber={$user_id} '>Atlet </a></td>";
                            echo "<td><a class='btn btn-info' href='supplier.php?source=view_supplier_order_product&o_p_id={$order_id}'>Lihat Tempahan</a></td>";
