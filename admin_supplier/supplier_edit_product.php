      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="productName" placeholder="" value="" required="Isi nama produk">
          ...
          <div class="col-md-6 mb-3">
            ...
            <select name="user_group_artistic"  id="">
                <option value="vegetable">Sayur-Sayuran</option>
