            ...
            <div class="card-header py-2">
                <div class="row">
                  ...
                  <div class="col-md-6" align="center">
					...
					<?php  
                    	echo "<div align='right'><a class='btn btn-danger' onClick=\"javascript: return confirm('Anda pasti untuk padam maklumat ini? '); \"  href='product.php?source=edit_product&delete={$product_id}'>Padam</a></div>";
					?>
                  </div>
                </div>
		  </div>
...
<!--            <input type="text" class="form-control" name="product_type" placeholder="" value="<?php echo $product_type; ?>" required="Isi nama produk">-->
            <div>
				<select name="product_type" class="btn border-secondary form-control">
					<option value="<?php echo $product_type; ?>">Pilih Jenis Produk...</option>
					<?php
